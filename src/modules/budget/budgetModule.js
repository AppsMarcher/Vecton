(function attachVectonBudget(window) {
  function createBudgetModule(deps) {
          ...
          <div class="content-card actuals-intake-card">
            ...
            <form id="budget-upload-form" class="form-grid actuals-upload-form">
              <label class="full-span vecton-file-field">
                ...
                <input id="budget-file-input" name="file" type="file" accept=".xlsx,.xls,.csv,.txt" class="vecton-file-native">
              </label>
    ...
    function bindEvents() {
      ...
      document.querySelector("#budget-file-input")?.addEventListener("change", (event) => {
