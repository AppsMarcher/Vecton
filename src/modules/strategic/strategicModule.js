(function attachVectonStrategicModule(window) {
  ...
  // MONTH_LABELS_SHORT/STATUS_META/ACTION_STATUS_*/formatByUnit/
  // formatTargetVariation extraídos pra strategicDataModule.js (2026-09-02),
  // mesmo padrão de comercialPainelDataModule.js — reaproveitado tal e qual
  // pela versão mobile (strategicMobileModule.js), sem duplicar formatação/
  // regra de negócio entre as duas telas.
  const {
