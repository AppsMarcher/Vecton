(function attachVectonComercialPlanejadoCarga(window) {
  ...
  function createComercialPlanejadoCargaModule(deps) {
          ...
          <div class="content-card actuals-intake-card">
            ...
            <form id="complan-upload-form" class="form-grid actuals-upload-form">
              <label class="full-span vecton-file-field">
                ...
                <input id="complan-file-input" name="file" type="file" accept=".xlsx,.xls,.csv,.txt" class="vecton-file-native">
              </label>
    ...
    function bindEvents() {
      ...
      document.querySelector("#complan-file-input")?.addEventListener("change", (event) => {
