(function attachVectonComercialVendasCarga(window) {
  ...
  function createComercialVendasCargaModule(deps) {
          ...
          <div class="content-card actuals-intake-card">
            ...
            <form id="comven-upload-form" class="form-grid actuals-upload-form">
              <label class="full-span vecton-file-field">
                ...
                <input id="comven-file-input" name="file" type="file" accept=".xlsx,.xls,.csv,.txt" class="vecton-file-native">
              </label>
    ...
    function bindEvents() {
      ...
      document.querySelector("#comven-file-input")?.addEventListener("change", (event) => {
