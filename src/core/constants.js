...
const VIEW_HEADER_METADATA = {
  ...
  fcLoad: { kicker: "PARÂMETROS", title: "Carga do Fluxo de Caixa" },
  fcPlan: { kicker: "PARÂMETROS", title: "Plano de Contas FC" },
  drePlan:     { kicker: "PARÂMETROS", title: "Plano de Contas DRE" },
